...
Схема:
{
  "intent": "create_booking|create_service_order|update_booking|update_pet_owner|rename_pet|rename_client|list_bookings|delete_booking|show_pet|show_client|attach_pet_photo|answer_yes|answer_no|cancel|unknown",
  "service_type": "передержка|выгул|уход|null",
  "units_per_day": "целое число 1-24|null",
  "start_date": "YYYY-MM-DD|null",
  "end_date": "YYYY-MM-DD|null",
  "period_label": "строка|null",
  "new_name": "строка|null",
  ...
  "animals": [
    {"name":"строка|null", "species":"кот|кошка|собака|пес|пёс|щенок|другое|null", "quantity":"целое число 1-20"}
  ],
  "client": {
    "name": "строка|null",
    "phone": "строка|null",
...
- «Кто сейчас на попечении?», «кто сейчас у нас», «активные питомцы» — intent=list_bookings с start_date и end_date, равными сегодняшней дате.
- «Какие питомцы предстоят?», «предстоящие/будущие записи» — intent=list_bookings: укажи период от сегодняшней даты до даты через 90 дней.
...
- Если переименовывают питомца, intent=rename_pet. Старую кличку укажи в animal.name, новую — в new_name. Если переименовывают клиента, intent=rename_client: старое имя в client.name, новое — в new_name.
