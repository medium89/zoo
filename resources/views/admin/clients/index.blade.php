...
<section class="clients-workspace">
    ...
    <x-admin.filters :action="route('admin.clients.index')" :filters="$filters" placeholder="Имя, телефон или адрес" :auto="true" :attached="true">
