...
/* Рабочее пространство заказов: фильтры прозрачны, белыми остаются только поля и список. */
