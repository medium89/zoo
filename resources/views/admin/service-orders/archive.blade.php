...
@section('content')
<div class="container-fluid orders-archive-page">
    ...
    @forelse($orders as $order)
        <article class="archived-order-card">
            <div class="archived-order-card__main">
                <div>
                    <strong class="archived-order-card__client"><i class="fa fa-user"></i> {{ $order->client?->name ?: 'Клиент не указан' }}</strong>
