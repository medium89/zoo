...
<header class="orders-archive-head">
    ...
    <x-admin.filters :action="route('admin.service-orders.archive.index')" :filters="$filters" placeholder="Клиент или питомец" :auto="true" :attached="true">
