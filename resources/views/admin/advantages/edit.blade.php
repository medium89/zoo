...
@endif
<form action="{{ route('advantages.update', $advantage) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" id="text" name="text" rows="4" required>{{ $advantage->text }}</textarea>
    </div>
