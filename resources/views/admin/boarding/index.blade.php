...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <form action="{{ route('admin.boarding.store') }}" method="POST" class="row g-3 align-items-end" id="boardingForm">
                @csrf
                <div class="col-md-4">
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    // Simple custom datepicker overlay
    ...
    function openPicker(input){
        ...
        const overlay = document.createElement('div'); overlay.className='dp-overlay';
        const box = document.createElement('div'); box.className='dp-box'; overlay.appendChild(box);
    ...
    function closePicker(){
        document.querySelectorAll('.dp-overlay').forEach(el=>el.remove());
    }
