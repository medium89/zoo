...
<body>
    ...
    <script type="text/javascript">
        ...
        })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=103576623', 'ym');

        ym(103576623, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", accurateTrackBounce:true, trackLinks:true});
    </script>
